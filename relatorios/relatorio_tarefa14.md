...
- Ambiente: maquina local, com os dois processos MPI no mesmo host
- Processadores logicos visiveis: `28`
- Compilacao: `mpicc -O3 -Wall -Wextra`
- Processos MPI: `2`
...
O CSV final tem `157` linhas: `156` medicoes mais o cabecalho. Isso corresponde a
`4` funcoes MPI, `13` tamanhos de mensagem e `3` rodadas por configuracao.
...
![Tempo por tamanho](tarefa14_tempo_por_tamanho.png)

![Largura de banda](tarefa14_largura_banda.png)
...
- Graficos: `relatorios/tarefa14_tempo_por_tamanho.png` e
  `relatorios/tarefa14_largura_banda.png`
