...
```text
AULA-01-P-GPU/tarefa-20/resultados/raw_cpu_*.log
AULA-01-P-GPU/tarefa-20/resultados/raw_gpu_*.log
```
...
```bash
sbatch --partition=gpu-4-a100 AULA-01-P-GPU/tarefa-20/run_nsys_npad.sbatch
```
...
```bash
scp usuario@servidor-do-npad:~/atividades-aula/AULA-01-P-GPU/tarefa-20/resultados/perfis/nsys_heat_gpu_*.nsys-rep .
```
